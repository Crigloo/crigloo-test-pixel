      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://datatrack.admaxim.com/datatracker/rdata?px=*&segid=*&ts=*&url=*"
              }
            ]
          }
        }
...
const pid = data.pid;
const udata = data.segmentId;
const sendPixel = require('sendPixel');
const getTimestamp = require('getTimestamp');
const getUrl = require('getUrl');
const encodeUriComponent = require('encodeUriComponent');

const trackingUrl = 'https://datatrack.admaxim.com/datatracker/rdata?px='+pid+'&segid='+udata+'&ts='+getTimestamp()+'&url='+encodeUriComponent(getUrl());
...
Created on 20/08/2019, 20:25:28
